...
ALTER TABLE TB_BAIRRO ADD FOREIGN KEY(id_cidade) REFERENCES TB_CIDADE (id_cidade)
ALTER TABLE TB_ESTADO ADD FOREIGN KEY(id_pais) REFERENCES TB_PAIS (id_pais)
