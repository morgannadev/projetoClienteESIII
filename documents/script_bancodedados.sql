...
ALTER TABLE TB_ENDERECO ADD FOREIGN KEY(id_tipo_residencia) REFERENCES TB_TIPO_RESIDENCIA (id_tipo_residencia)
ALTER TABLE TB_ENDERECO ADD FOREIGN KEY(id_tipo_endereco) REFERENCES TB_TIPO_ENDERECO (id_tipo_endereco)
ALTER TABLE TB_ENDERECO ADD FOREIGN KEY(id_bairro) REFERENCES TB_BAIRRO (id_bairro)
ALTER TABLE TB_ENDERECO ADD FOREIGN KEY(id_cidade) REFERENCES TB_CIDADE (id_cidade)
ALTER TABLE TB_ENDERECO ADD FOREIGN KEY(id_estado) REFERENCES TB_ESTADO (id_estado)
ALTER TABLE TB_ENDERECO ADD FOREIGN KEY(id_pais) REFERENCES TB_PAIS (id_pais)
